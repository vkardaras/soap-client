 ...
 * 
 */
@WebServiceClient(name = "CountriesPortService", targetNamespace = "http://soap.soap_provider.vasiliskardaras.com", wsdlLocation = "http://localhost:8080/ws/countries.wsdl")
    ...
    extends Service
{
    ...
    private final static QName COUNTRIESPORTSERVICE_QNAME = new QName("http://soap.soap_provider.vasiliskardaras.com", "CountriesPortService");
    ...
    public CountriesPort getCountriesPortSoap11() {
        return super.getPort(new QName("http://soap.soap_provider.vasiliskardaras.com", "CountriesPortSoap11"), CountriesPort.class);
    }
    ...
    public CountriesPort getCountriesPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.soap_provider.vasiliskardaras.com", "CountriesPortSoap11"), CountriesPort.class, features);
    }
